    ...
    return SizedBox(
        ...
        child: Column(
          ...
          children: [
                        ...
                        child: Padding(
                            ...
                            child: InkWell(
                                ...
                                child: CircleAvatar(
                                    ...
                                    child: Icon(Icons.favorite, size: 14, color: post.active ? HomePageCore.postFavouriteIconONColor : HomePageCore.postFavouriteIconOFFColor)
                                )
                            )
                        )
                    ),
            ...
            // # cost text
            Text('от ${post.price.uzs_price} сум', style: HomePageCore.postCostTextStyle),
          ],
        )
    );
  }
